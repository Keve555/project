			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="index.php?prog=features.php">Features</a></li>
						<li><a href="index.php?prog=video.php">Video</a></li>
						<li><a href="index.php?prog=clients.php">Clients</a></li>

						<li><a class="btn btn-link-3" href="index.php>prog=login.php">Login</a></li>
						<li><a class="btn btn-link-3" href="index.php>prog=register.php">Register</a></li>
					</ul>
				</div>
			</div>
		</nav>
